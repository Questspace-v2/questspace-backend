CREATE TYPE access_type AS ENUM ('public', 'link_only');

CREATE TYPE verification_type AS ENUM ('auto', 'manual');
...
(
    ...
    description varchar,
    access access_type DEFAULT 'link_only',
...
(
    ...
    verification verification_type DEFAULT 'auto',
...
ALTER TABLE quest ADD FOREIGN KEY (creator) REFERENCES "user" (username);

ALTER TABLE team ADD FOREIGN KEY (capitan) REFERENCES "user" (username);
